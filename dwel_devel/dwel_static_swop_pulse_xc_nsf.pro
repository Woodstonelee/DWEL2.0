...
;+
; NAME:
;DWEL_STATIC_SWOP_PULSE_XC_NSF
;
; PURPOSE:
;This cross correlation is to process fake data made from stationary scans. 
...
;
; CALLING SEQUENCE:
;dwel_static_swop_pulse_xc_nsf, inbsfixfile, inbsfixancfile, outxcfile, zen_tweak, ierr
;
; INPUTS:
...
;data. 
;outxcfile = output file name of the cross-correlation results. NOT the baseline
;refixed file (the update file)
...
;  envi_batch_init, /no_status_window
  ...
  print, '*******************************************'
  print, 'Processing program = dwel_static_swop_pulse_xc_nsf'
