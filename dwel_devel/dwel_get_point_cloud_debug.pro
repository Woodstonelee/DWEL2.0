;======================================================================
pro dwel_apply_ptcl_filter_debug, p, pb_stats, pb_meta, pb_info, error=error 
...
;; generation. 
pro dwel_get_point_cloud_debug, infile, ancfile, outfile, err, Settings=settings
...
;  envi_batch_init, /no_status_window
  ...
  ;********************************************
  perr=0b
  dwel_apply_ptcl_filter_debug,p,pb_stats,pb_meta,pb_info,error=perr
  ;********************************************
